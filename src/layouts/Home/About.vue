<template>
  <section id="about" class="py-20 bg-light text-gray-900 scroll-target">
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative">
          <div class="rounded-xl overflow-hidden shadow-2xl">
            <img alt="Team discussion in modern office" class="w-full"
                 src="https://modao.cc/agent-py/media/generated_images/2025-12-03/0fe84080799c4f82850cb2857fe04b60.jpg"/>
          </div>
        </div>
      </div>
    </div>
